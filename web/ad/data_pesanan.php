 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- main content start-->
		<div class="main-content main-content4 m-scene" id="main">
			...
			$sql_pe=mysql_query("SELECT * FROM data_penjual");
		...
		<?php };?>
					 <div class="xs tabls">
						...
						<div class="filter">
								...
								<input class="form-control1" type="date" name="tanggal" placeholder="Search Product" style="width:200px !important"/>
						...
						if (!empty($_GET['page'])) {
						  ...
						  $i=1;
						  $sql_pesanan=mysql_query("SELECT * FROM data_pesanan INNER JOIN data_pembeli ON data_pembeli.email=data_pesanan.id_pembeli WHERE 1=1 $filter_status $filter_tanggal $filter_pembeli order by tanggal DESC limit $MulaiAwal , $BatasAwal");
						...
						?>
							  ...
							  <a href="../proses/disapprove_pesanan_ad.php?id=<?php echo $aray_pesanan['id_pesanan']?>" class="tooltipp tutup" title="Disapprove"><span class="lnr lnr-cross-circle" style="color: red;"></span></h3></a>
							  </td>
							</tr>
							<script>
						...
						<?php
							$cek_data = mysql_query("SELECT * FROM data_pesanan WHERE 1=1 AND status!='' $filter_status $filter_tanggal $filter_pembeli ");
