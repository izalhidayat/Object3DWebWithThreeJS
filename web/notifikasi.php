...
<script>
 $(document).ready(function() {
     $("#is").load("response.php?id_toko=<?php echo $id_toko?>");
   var refreshId = setInterval(function() 
      {
      $("#is").load('response.php?id_toko=<?php echo $id_toko;?>&randval='+ Math.random());
							...
							<li class="dropdown">
								<a href="" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-tasks"></i><span class="badge blue1"><?php echo $cek_data_pending ?></span></a>
									<ul class="dropdown-menu">
										<li>
											<div class="notification_header">
												<h3>Process Waiting</h3>
											</div>
										</li>
										
										<li><a href="data_penjualan.php">
												<div class="task-info">
												<span class="task-desc">Products Not Delivered</span><span class="percentage"><?php echo $cek_data_pending ?></span>
								...
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(../images/1.jpg) no-repeat center"> </span> 
										 <div class="user-name">
											<p><?php echo $nama_user?><span>Seller</span></p>
										 </div>
